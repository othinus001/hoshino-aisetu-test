...
class Spider(object):
    ...
    def download_icon_unit(self, start=1001, end=1200, star=3):
        ...
        for i in range(start, end):
            src_n = get_pic_name(i, '', f'{star}0.webp')
            dst_n = get_pic_name(i, 'icon_unit_', f'{star}0.png')
...
if __name__ == '__main__':
    spider = Spider()
    # 运行过程出现404和200属正常情况
    spider.download_icon_unit(start=3901, end=3902, star=0)
    #spider.download_icon_unit(start=8999, end=9001, star=1)
