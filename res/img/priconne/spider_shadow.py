...
class Spider(object):
    ...
    def download_icon_unit(self, start=1001, end=1200, star=3):
        base = 'https://redive.estertion.win/icon/unit_shadow/'
        save_dir = './unit_shadow/'
...
if __name__ == '__main__':
    spider = Spider()
    # 运行过程出现404和200属正常情况
    spider.download_icon_unit(start=1113, end=1115, star=3)
    #spider.download_icon_unit(start=1001, end=1038, star=1)
    #spider.download_icon_unit(start=1001, end=1040, star=6)
    #spider.download_icon_unit(start=1800, end=1809, star=3)
    # 如果需要爬取漫画，取消掉下面的这行注释
